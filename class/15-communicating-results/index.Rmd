...
## - In class, 12/14 (6:00 - 7:20)

## - 10 minutes (strict)

## - Slides due in team Box by midnight on 12/13

---

class: middle, center

# Download [this cheetsheet](https://github.com/emse-madd-gwu/2022-Fall/raw/main/content/cheatsheet-storytelling.pdf) for today's content
...
1. **Automated Vehicles**: Oladele, Vikram, Christine, Sanskriti
2. **Leaf Blowers**: Sameer, Priyanka, Raffa
3. **Remote Work**: Haokai, Sravya, Malyadri Reddy, Michael
4. **Student Housing**: Maximillian, Alejandro, Margaret, Bassant
5. **World Cup**: Kyle, Ava, Vibhav, Prathyaj
...
# .center[[Final Reports](https://madd.seas.gwu.edu/2022-Fall/project/6-final-analysis.html) (Due 12/11...you have 4 days left!)]
...
# .center[[Final Presentations](https://madd.seas.gwu.edu/2022-Fall/project/7-final-presentation.html) (Due 12/13)]
