...
# Meat preference with RED wine 
# (positive means STEAK preferred, negative means FISH preferred): 
wine_red_steak - wine_red_fish

# Meat preference with WHITE wine 
# (positive means STEAK preferred, negative means FISH preferred):
wine_white_steak - wine_white_fish
