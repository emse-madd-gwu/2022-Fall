...
# Read in rubric data
rubric <- read_csv(here::here('rubrics', 'survey-plan.csv'))
maxPoints <- rubric %>%
...
Click the "knit" button to compile your `survey_plan.Rmd` file into a html web page, then create a zip file of everything in your R Project folder. Name your file `survey-plan.zip`, then go to your team Box folder and submit your zip file in the "submissions" folder. Only one person from your team should submit the report.
