...
# Read in rubric data
rubric <- read_csv(here::here('rubrics', 'proposal.csv'))
maxPoints <- rubric %>%
...
As a team, write a proposal defining the scope of your project plan. Your chosen project topic should follow the [project selection guidelines](../project/0-overview.html#Project_Selection).
...
Click the "knit" button to compile your `proposal.Rmd` file into a html web page, then create a zip file of everything in your R Project folder. Go to your team Box folder and submit your zip file in the "submissions" file. Only one person from your team should submit the report.
