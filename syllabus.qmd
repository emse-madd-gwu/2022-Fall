...
<i class="fas fa-envelope"></i> [jpg@gwu.edu](mailto:jph@gwu.edu) | <i class="far fa-clock"></i> {{< var time >}}
<i class="fab fa-twitter"></i> [\@JohnHelveston](https://twitter.com/JohnHelveston) | <i class="fab fa-slack"></i> [Slack]({{< var slack >}})
</div>
...
- We'll be using [Slack]({{< var slack >}}) for most communication.
...
All course communication will be managed through [Slack]({{< var slack >}}). A link to sign up for the course slack page can be found on the one (and only) announcement on Blackboard.
